...
`comp.scm` contains a compiler for QWAK Lisp, written in QWAK Lisp, and
 targeting a custom ISA (described towards the end of this file). Likewise,
 its output is in a custom assembly, tailored to that architecture.
